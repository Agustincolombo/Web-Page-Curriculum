...
export function Presentacion({ onNavigate }: PresentacionProps) {
  return (
    <div id="presentacion" className={s['presentacion-container']}>
      <section id="inicio" className={s['hero-section']}>
        <nav className={s['hero-nav']}>
          ...
          <a href="https://drive.google.com/uc?export=download&id=1MJBa5C-S1dBenJ_6cQm0RO-LeOj1yqgN" target="_blank" rel="noopener noreferrer" className={s['cv-button']}>
            Download CV ↓
          </a>
        </nav>
        ...
        <div className={s['hero-content']}>
          ...
          <div className={s['hero-right']}>
            <div className={s['hero-info']}>
              <h1 className={s['name']}>{personalData.name}</h1>
              <div className={s['divider']} />
              <h2 className={s['profession']}>{personalData.profession}</h2>
              <p className={s['tech-stack']}>{personalData.techStack}</p>
